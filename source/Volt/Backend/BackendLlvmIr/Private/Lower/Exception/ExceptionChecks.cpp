...
void Volt::Backend::Llvm::ExceptionLowering::EmitExceptionCheck ( BodyEmitter &Emitter )
{
    ...
    llvm::Value *Tag     = Builder.CreateLoad( Int32Ty, ExceptionTagSlot( Builder ), "exc.tag" );
...
void Volt::Backend::Llvm::ExceptionLowering::EmitUnwindCheck ( BodyEmitter &Emitter )
{
    ...
    llvm::Value *ExcPending = Builder.CreateICmpNE(
        Tag, llvm::ConstantInt::get( Int32Ty, MiddleEnd::TypeSystem::NominalId::InvalidValue ), "exc.pending" );
    llvm::Value *Brk     = Builder.CreateLoad( Builder.getInt1Ty(), BreakFlagSlot( Builder ), "brk.pending" );
