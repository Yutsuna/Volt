...
Int32 Volt_Dispatch( FVmContext* Ctx )
{
	...
	if ( !Inited )
	{
		...
		DispatchTable[ 61 ] = &&LNop;
		DispatchTable[ 62 ] = &&LAddIntImm;
		DispatchTable[ 63 ] = &&LSubIntImm;
		DispatchTable[ 64 ] = &&LEqIntImm;
		DispatchTable[ 65 ] = &&LNeIntImm;
		DispatchTable[ 66 ] = &&LBrLtInt;
		DispatchTable[ 67 ] = &&LBrLeInt;
		DispatchTable[ 68 ] = &&LBrGtInt;
		DispatchTable[ 69 ] = &&LBrGeInt;
		DispatchTable[ 70 ] = &&LBrEqInt;
		DispatchTable[ 71 ] = &&LBrNeInt;
		DispatchTable[ 72 ] = &&LBrLtIntImm;
		DispatchTable[ 73 ] = &&LBrLeIntImm;
		DispatchTable[ 74 ] = &&LBrGtIntImm;
		DispatchTable[ 75 ] = &&LBrGeIntImm;
		DispatchTable[ 76 ] = &&LBrEqIntImm;
		DispatchTable[ 77 ] = &&LBrNeIntImm;
		DispatchTable[ 78 ] = &&LLoadPtr;
		DispatchTable[ 79 ] = &&LStorePtr;
		DispatchTable[ 80 ] = &&LPtrAdd;
		DispatchTable[ 81 ] = &&LPtrSub;
		DispatchTable[ 82 ] = &&LAddrLocal;
		DispatchTable[ 83 ] = &&LAddrField;
		Inited = 1;
	}
