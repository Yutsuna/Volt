...
namespace Volt::MiddleEnd::Analysis::Raii
{
...
// no metric can undo.
VOLT_MIDDLEEND_ANALYSIS_EXPORT void InferReturnOwnership ( std::span<const Frontend::AstContext *const> Units, TypeStore &Store );
...
VOLT_MIDDLEEND_ANALYSIS_EXPORT void InferParameterEscape ( std::span<const Frontend::AstContext *const> Units, TypeStore &Store );
...
[[nodiscard]] VOLT_MIDDLEEND_ANALYSIS_EXPORT Volt::Core::SmallVec<bool, 4>
