...
namespace MiddleEnd::Resolver
{
    ...
    using ScopeId = ::Volt::Core::TypedId<ScopeTag>;
    ...
    // never a copy of the node. Defined in TypeSystem/BindingSite.hpp — see
    // that header's comment for why (TypeSystem needs it too, and must not
    // depend back on Resolver).
    using TypeSystem::BindingSite;
    using TypeSystem::BindingSiteHash;
    using TypeSystem::IsValueBinding;
    ...
    struct Scope
    {
        ...
        ::Volt::Core::SmallVec<Symbol, 4> Order; // declaration order (stable diagnostics)
    ...
    class VOLT_MIDDLEEND_RESOLVER_EXPORT ScopeTable
    {
    ...
    public:
        ...
        [[nodiscard]] const ::Volt::Core::SmallVec<Capture, 4> *CapturesOf ( ScopeId Scope ) const
        {
        ...
        [[nodiscard]] const ::Volt::Core::SmallVec<Capture, 4> *CapturesOfExpr ( Frontend::ExprId Expr ) const
        {
    ...
    private:
        ...
        ::Volt::Core::Arena<Scope, ScopeId> Scopes;
        ...
        std::unordered_map<ScopeId, ::Volt::Core::SmallVec<Capture, 4>> ClosureCaptures;
