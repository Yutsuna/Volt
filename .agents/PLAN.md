...
2. **[FEUILLE DE ROUTE FRONTEND / MIDDLE-END] :**
   ...
   - **[PROCHAINE ÉTAPE] Étape B : Inférence des littéraux flottants & collections (`UnconstrainedLiterals`) :** Étendre l'inférence tardive aux `FloatLiteral`, `ArrayLit` et `HashLit`.
