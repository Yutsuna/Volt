...
*   [Architecture Rules](file:///home/Yutsuna/Volt/.agents/rules/architecture.md) — VM & Memory model constraints (RAII, tag-free words, threaded dispatch, Cranelift JIT).
*   [Volt Coding Style Rules](file:///home/Yutsuna/Volt/.agents/rules/coding_standards.md) — Volt syntax rules (Ruby/Crystal style, no `let`/`var`/`const`, `def`, `->`, `end`).

---

## 4. Skills Available
*   [krystal-runner](file:///home/Yutsuna/Volt/.agents/skills/krystal_runner/SKILL.md) — Automates building and testing the Crystal codebase using `krystal`.
*   [volt-codegen](file:///home/Yutsuna/Volt/.agents/skills/volt_codegen/SKILL.md) — Code generation utility instructions for Volt syntax correctness.
