...
[[nodiscard]] Core::SmallVec<SemaTypeId, 2> SlotTypes ( TypeCheckerContext &Context, NominalId Base, const NodeType &Node )
{
...
[[nodiscard]] SemaTypeId LiteralType ( TypeCheckerContext &Context, Frontend::ExprId Id, const NodeType &Node )
{
    ...
    else
    {
        ...
        Core::SmallVec<SemaTypeId, 2> Args = SlotTypes( Context, *Base, Node );
