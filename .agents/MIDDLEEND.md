...
At the exit of the MiddleEnd, the AST/HIR delivered to the backend (see [`rules/core-ast.md`](rules/core-ast.md) for the complete contract — **26 core nodes**, with `CalleeResolution` and `ClosureEnvFrame` fully precomputed) is:
