...
//   - the public headers (Public/Volt/BackendLlvmIr/IrGenerator.hpp, and
//     BackendLLVM's LlvmEmitter.hpp) mention no LLVM type whatsoever,
//     forward-declared or not. LlvmAccess.hpp is the one deliberate exception,
//     and exists precisely so that it is the only one.
//
