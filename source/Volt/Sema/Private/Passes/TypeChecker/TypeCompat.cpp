...
[[nodiscard]] bool IsWideningScalar ( const TypeCheckerPass::TypeCheckerContext &Context, SemaTypeId Target, SemaTypeId Value )
{
...
[[nodiscard]] bool IsNilInto ( const TypeCheckerPass::TypeCheckerContext &Context, SemaTypeId Target, SemaTypeId Value )
{
...
bool Volt::Sema::TypeCheckerPass::IsAssignable ( const TypeCheckerContext &Context, SemaTypeId Target, SemaTypeId Value )
{
...
void Volt::Sema::TypeCheckerPass::CheckAssignable ( TypeCheckerContext &Context,
                                                    Frontend::ExprId ValueExpr,
                                                    SemaTypeId Target,
                                                    EAssignSite Site )
{
