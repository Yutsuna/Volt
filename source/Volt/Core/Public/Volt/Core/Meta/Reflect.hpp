...
namespace Volt
{
    ...
    namespace Meta
    {
        ...
        constexpr void ForEachField( T& Object, Fn&& Callback )
        {
            std::apply( [&]( auto... Fields )
                        { ( Callback( Fields.Name, Object.*( Fields.Ptr ) ), ... ); },
                        std::remove_cvref_t<T>::ReflectFields() );
        }
...
#define VOLT_FIELD_ENTRY( NAME ) ::Volt::Meta::Field{ VOLT_STRINGIFY( NAME ), &Self::NAME }
