...
private:
    ...
    [[nodiscard]] Frontend::ExprId MakeFacade ( std::string_view Method, Volt::Core::SourceRange Loc )
    {
        Volt::Core::StringInterner &Strings = Context.Strings();
    ...
    {
        const Volt::Core::SourceRange Loc = Element.Loc;
    ...
    {
        const Volt::Core::SourceRange Loc = Fragment.Loc;
    ...
    {
        const Volt::Core::SourceRange Loc = Text.Loc;
